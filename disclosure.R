                    ...
                    column(4,
                        ...
                        paste(
                          "<ul>",
                              ...
                              "<li> Only general characteristic information has been accounted for in this App (Age, Sex, Country, and Year of treatment; Censoring time is used for calibration in the setting of informative censoring); It requires update in the future with more important factors available.",
                             "<li> Consulting statisticians is always recommended if any important inplausible estimations occur due to the possibility of selection bias",
